...
class iOSCredentialsManager {
    constructor(logger, job) {
        ...
        this.logger = logger;
        this.job = job;
        this.distributionCertificatePath = path_1.default.join(os_1.default.tmpdir(), `${v4_1.default()}.p12`);
    }
    async prepare() {
        ...
        await fs_extra_1.default.writeFile(this.distributionCertificatePath, Buffer.from(credentials.distributionCertificate.dataBase64, 'base64'));
        try {
            ...
            await this.keychain.importCertificate(this.distributionCertificatePath, credentials.distributionCertificate.password);
            this.logger.info('Initializing provisioning profile');
            this.provisioningProfile = new provisioningProfile_1.default(this.logger, Buffer.from(credentials.provisioningProfileBase64, 'base64'));
