...
const fastlane_1 = __importDefault(require("../utils/fastlane"));
const gymfile_1 = require("../utils/gymfile");
async function buildGeneric(ctx) {
    const { job, logger } = ctx;
    const { buildDirectory, nativeProjectDirectory } = await project_1.setup(ctx);
    logger.info('Installing pods');
    await spawn_1.default('pod', ['install'], { cwd: nativeProjectDirectory, logger });
