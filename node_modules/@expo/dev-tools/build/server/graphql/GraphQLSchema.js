...
const resolvers = {
  ...
  Project: {
    ...
    config(project) {
      return (0, _asyncToGenerator3.default)(function* () {
        try {
          var _ref = yield (0, _config.readConfigJsonAsync)(project.projectDir);

          const exp = _ref.exp;

          return exp;
        } catch (error) {
          _xdl.ProjectUtils.logError(project.projectDir, 'expo', error.message);
          return null;
        }
      })();
    },
  ...
  Query: {
    ...
    processInfo(parent, args, context) {
      return (0, _asyncToGenerator3.default)(function* () {
        ...
        let platforms = [];
        try {
          var _ref2 = yield (0, _config.readConfigJsonAsync)(currentProject.projectDir);

          const exp = _ref2.exp;

          platforms = exp.platforms;
        } catch (error) {
          _xdl.ProjectUtils.logError(currentProject.projectDir, 'expo', error.message);
        }

        return {
          isAndroidSimulatorSupported: _xdl.Android.isPlatformSupported(),
          isIosSimulatorSupported: _xdl.Simulator.isPlatformSupported(),
          webAppUrl: platforms.includes('web') ? yield _xdl.UrlUtils.constructWebAppUrlAsync(currentProject.projectDir) : null
        };
      })();
    },
    user() {
  ...
  Mutation: {
    ...
    optimizeAssets(parent, { settings }, context) {
      return (0, _asyncToGenerator3.default)(function* () {
        ...
        yield (0, _spawnAsync2.default)('npx', ['expo-optimize'], {
    ...
    setProjectConfig(parent, { input }, context) {
      return (0, _asyncToGenerator3.default)(function* () {
        ...
        var _ref3 = yield (0, _config.writeConfigJsonAsync)(currentProject.projectDir, filteredInput);
