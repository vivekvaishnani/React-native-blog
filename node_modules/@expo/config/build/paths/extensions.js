...
function getExtensions(platforms, extensions, workflows) {
    ...
    invariant_1.default(Array.isArray(platforms), 'Expected: `platforms: string[]`');
    invariant_1.default(Array.isArray(extensions), 'Expected: `extensions: string[]`');
    invariant_1.default(Array.isArray(workflows), 'Expected: `workflows: string[]`');
...
function getManagedExtensions(platforms, languageOptions = { isTS: true, isModern: true, isReact: true }) {
